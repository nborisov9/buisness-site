...
//MENU BURGER===============================================
let iconMenu = document.querySelector(".menu-header__icon");//меняем класс, который в html
let body = document.querySelector("body");						// есть в заготовках, где span
let menuBody = document.querySelector(".menu-header__menu");//меняем класс, который в html
if (iconMenu) {															//Его стилизуют под мобилку
...
function map(n){
	...
	var icon={
		...
		scaledSize: new google.maps.Size(24, 29), // размер, ширина/ высота
		anchor: new google.maps.Point(12, 15) // сдвижение иконки
	}
